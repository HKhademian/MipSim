...
public class Multiplexer {
	...
	public static void aluResult(List<Value> aluControlInput, List<MutableValue> add
		, List<MutableValue> sub, List<MutableValue> and, List<MutableValue> or
		, List<MutableValue> setOnLessThan, List<MutableValue> shiftLogicalLeft
		, List<MutableValue> shiftLogicalRight, List<MutableValue> result) {
